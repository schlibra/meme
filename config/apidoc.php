...
return [
    ...
    'responses'=>[
        // 成功响应体
        'success'=>[
            ['name'=>'code','desc'=>'响应码','type'=>'int','require'=>1, 'default'=>200],
            ['name'=>'msg','desc'=>'响应消息','type'=>'string','require'=>1, 'default'=>"请求成功"],
            //参数同上 headers；main=true来指定接口Returned参数挂载节点
            ['name'=>'data','desc'=>'返回数据','main'=>true,'type'=>'object','require'=>false],
            ['name'=>'token','desc'=>'登录或发送邮件返回认证Token', 'type'=>'string', 'require'=>false],
            ['name'=>'count','desc'=>'分页时数据总条数', 'type'=>'int', 'require'=>false],
        ],
        // 异常响应体
        'error'=>[
            ['name'=>'code','desc'=>'响应码','type'=>'int','require'=>1],
            ['name'=>'msg','desc'=>'响应消息','type'=>'string','require'=>1],
        ]
    ],
